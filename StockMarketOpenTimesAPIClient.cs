...
namespace APIVerve
{
    public class StockMarketOpenTimesAPIClient
    {
        ...
        public StockMarketOpenTimesAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public StockMarketOpenTimesAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
