...
{
    /// <summary>
    /// Client for the APIVerve.API.StockMarketOpenTimes API
    /// </summary>
    public class StockMarketOpenTimesAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/stockmarketopentimes";
        ...
        public StockMarketOpenTimesAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public StockMarketOpenTimesAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public StockMarketOpenTimesAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, StockMarketOpenTimesQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        public ResponseObj Execute(StockMarketOpenTimesQueryOptions options = null)
        {
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        public Task<ResponseObj> ExecuteAsync(StockMarketOpenTimesQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(StockMarketOpenTimesQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(StockMarketOpenTimesQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(StockMarketOpenTimesQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(StockMarketOpenTimesQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(StockMarketOpenTimesQueryOptions options)
        {
